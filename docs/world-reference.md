...
> 對接 bible §9.2。**設計（已定）**：分支機制＝**決定性分歧章（一次鎖定）**；帝國結局性質＝**「牢籠長存」**；分歧內容量＝**完整平行戰役**。**自洽根**：死亡時鐘只在「喚醒領航者」啟動（bible §50／§10.4），所以不接真相的帝國線＝時鐘從未響、造物主永不知座標、世界在謊言中安穩續存。

### I.1 分歧點：第二章的決定性抉擇

- ch.1（邊陲）、ch.2（邊境領主）為**共用流程**：建立世界、初遇審判官壓迫與燼火。
- **第二章高潮＝決定性分歧（一次鎖定）**：在「政教角力、審判官清洗」白熱時，玩家被迫選邊並當場鎖路——
  - **投反抗**（燼火／離心領主／啟明會）→ 走**真相線**（I.2）。
  - **助帝國**（審判庭／親王派）鎮壓反抗軍 → 走**帝國線**（I.3）。
- **閘門約束（自洽）**：分歧**必須在 ch.4 喚醒領航者之前**——這正是把它放在第二章的原因。倒向帝國＝再也走不到喚醒那一步，死亡時鐘永不啟動。

### I.2 真相線（反抗）＝真結局

即 §9.1 既有大弧：ch.3 深入帝國 → ch.4 喚醒領航者（時鐘啟動）→ ch.5 聖城半揭 → 終章泰拉全揭／逃離。結局：把衛星化為**流浪方舟**逃離（領航者獻祭斬鏈／或被救之變體，見 H.4）。**末日卻解放。**

### I.3 帝國線（壓迫秩序）＝牢籠長存（完整平行戰役）

與真相線**鏡像對照**的中後期戰役：

| 章 | 帝國線 | 與真相線的鏡像 |
|---|---|---|
| ch.3′ **平叛** | 受審判庭／帝國重用，掃蕩燼火在帝國本土的網絡，追剿啟明會、清洗離心領主 | 真相線在此結交盟友，帝國線在此**獵殺**他們 |
| ch.4′ **封印** | 啟明會圖謀喚醒「聖髑」，玩家奉命阻止、將領航者**更深封印**——親手關上通往真相（與末日）的門 | 與真相線 ch.4「喚醒」完全鏡像；**死亡時鐘永不啟動**的關鍵節點 |
| ch.5′ **晉身** | 平步青雲、受封進帝心、成為秩序支柱（新晉審判長／皓月之子近臣）；或瞥見「至聖本體」異常，被教義說服、選擇不深究 | 真相線攻入聖城揭穿，帝國線**走進聖城卻甘心不問** |
| 終章′ **牢籠長存** | 你坐上高位，世界在謊言中「安穩」續存——時鐘從未響、造物主仍不知情、暴政與謊言永埋 | — |

> **終章′ 的最後一刀（反諷）**：你頭頂膜拜的神居正是 AI 的囚牢，你用一生維護的「安全」就是這座牢籠，而**你永遠不會知道**。**安穩卻沉淪。**
...
| **覆滅**（fail，可選） | 真相線 | 悲劇 | 沒搶到關鍵或沒及時升空，被造物主吞沒 |
| **牢籠長存** | 帝國線 | 安穩卻沉淪 | 維持牢籠而「贏」，真相永埋、你永遠不會知道 |

### I.5 帝國線的關係演變（鏡像 A.7.6）

| 關係對 | 起點 → 終點 | 驅動 |
|---|---|---|
| 玩家 × 教會／審判庭 | ✕ → **◎ 棟梁** | 助其鎮壓、平步青雲 |
| 玩家 × 燼火／啟明會 | △ → **⊗ 獵殺** | 親手剿滅前可能的盟友 |
| 玩家 × 離心領主（哈洛） | △／○ → **✕ 清洗** | 倒向帝國、清算離心 |
| 玩家 × 領航者 | **永不相遇**（封印加深） | 從不喚醒 |
| 玩家 × 造物主 | **永不知情**（時鐘從未啟動） | 牢籠長存的根 |
