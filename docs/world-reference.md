...
> 對接 bible §7。原則：帝國—教會是壓迫秩序的兩根柱子，底下多方摩擦＝近景事件的養分。命名走「中文俗名＋拉丁聖號」。**第一章橡境五位（卡西安／哈洛／多恩／伊利安／瑪歌）的深寫細節檔見 A.8；全政治盤面＋領航者的「決策模型」（推演行動用）見 A.9；核心人員全名冊（25 位）見 A.10。**
...
> **深淺**：橡境前期 5 位＋攝政＋餘燼寫滿；頂層（皇帝/聖座）與學派（求是/隱修）給核心欄，後期再補；領航者用特殊的**表意識 vs 潛意識雙層模型**。
...
> **觸發 → 反應**：①帝國高壓清洗→轉入更深地下、以殉難者神話再動員。②玩家證明可靠→納入網絡、賦予更重任務。③啟明會帶來真相→Phase 2 合流，從反暴政升級為「破禁忌、奪船」同盟。④玩家倒向帝國→成為被獵殺的前盟友（帝國線 ⊗）。

#### A.9.8 皇帝賽弗里安二世「白燼皇帝」〔核心欄〕
...
> **觸發 → 反應**：①攝政架空太過→暗中扶植制衡力量。②教會逾矩→隱忍但記恨。③後期玩家攪動政局→可能成為各方爭奪的棋眼（誰挾天子）。

#### A.9.9 皓月聖座克萊門斯七世〔核心欄〕
...
> **觸發 → 反應**：①聖髑被喚醒（醜聞）→動用整個審判庭死命追緝、要重新封埋。②玩家逼近聖城本體→以「真相會毀掉社會」之名，遞「悔罪招安」或全力剿滅。③攝政剪神權→以神權手段反制。
...
> **觸發 → 反應**：①玩家帶來遺物／異常現象→好奇心壓過警覺、想研究（意外踩進真相）。②教會施壓→退縮或轉向求庇護（離心領主／燼火）。③學院鬥爭→務實選邊保學術。

#### A.9.11 靜默隱修會緘默者瑟雷恩〔核心欄〕
...
> **觸發 → 反應**：①伊利安／玩家來探「聖髑」古祕→戒慎試探，確認誠意才吐露碎片。②俗世勢力逼問→緘默、隱遁。③真相線推進→成為通往眠龕的暗線提供者。

#### A.9.12 領航者（特殊：表意識 vs 潛意識雙層模型）

> **一句人格**：最忠誠的守護者，被自己想救的怪物借走了手——她的每個決定都有兩個作者。
> **雙層決策模型**（汙染後，對接 §10.4、H.1）：
> - **表意識（她以為的自己）**：真心想幫這群「孩子」找到生路、拼回自己錯亂的記憶。價值＝守護人類 ＞ 找回自我；決策＝暗示型引導、只給方向不給答案。
> - **潛意識（被汙染植入，她毫不自覺）**：朝母星的期盼行事——把眾人引向「驅動飛船、回泰拉」的陷阱。
> **衝突如何解（預測引擎）**：凡涉及「是否更靠近母星／泰拉／奪船」的抉擇，**潛意識會悄悄勝出**、把結論導向「該回那顆星」；其餘日常抉擇由表意識主導（真誠幫忙）。故她的行動＝**真誠善意 ＋ 在關鍵分岔處不自覺偏向母星**。
> **立場**：玩家＝最信任的引導者（她真心、玩家也信）｜神教＝（被汙染地）煽動成「最終 Boss」｜真相＝她是真相的化身卻拼不全｜母星＝異常的歸航衝動。
> **觸發 → 反應**：①一般抉擇→以玩家存續為念、給暗示。②涉及靠近泰拉／奪船→不自覺強力推動（亢奮、話頭引向母星，H.1 伏筆）。③玩家起疑質問→困惑、無法解釋自己（因為她也不知道）。④終章斬鏈關頭→唯一清醒，主動關閉內線、自獻掩護（H.4）。
> **鐵則**：終章前玩家可察覺伏筆，但她與隊伍不點破。
...
> 深度標記：**深**＝細節檔(A.8)｜**模**＝決策模型(A.9)｜**核**＝決策模型核心欄｜**綱**＝outline。

| # | 暫名 | 隸屬 / 區域 | 一句定位 | 深度 |
|---|---|---|---|---|
| 1 | 領航者·聖露希亞 | 引導者（超然／聖髑） | 被汙染的悲劇引導者、唯一 AI 內線 | 深·模(A.9.12) |
...
| 9 | 皇帝賽弗里安二世 | 帝國·皇權 | 被供奉的空殼 | 核(A.9.8) |
| 10 | 聖座克萊門斯七世 | 教會·聖座 | 仁慈之名下的鐵腕、最深權力 | 核(A.9.9) |
| 11 | 求是院祭酒歐德蘭 | 求是院 | 越界的求知者 | 核(A.9.10) |
| 12 | 隱修會緘默者瑟雷恩 | 靜默隱修會 | 守密的苦修者 | 核(A.9.11) |
| 13 | 守衛隊長「鐵手」哈爾 | 橡境·哈洛家臣 | 橡鎮第一張臉、哥布林任務發包 | 綱(A.8.2) |
| 14 | 霜冠公·柯爾溫 | 帝國親王派·霜垠 | 礦業附庸親王、催苛役 | 綱(A.10) |
| 15 | 綠洲總督·塞拉斯 | 帝國親王派·赤沙 | 半自治綠洲總督、政治莊家 | 綱(A.10) |
| 16 | 鐵橋伯·瑞德蒙 | 離心領主·鐵橋城 | 第二章樞紐、更大的庇護者 | 綱(A.10) |
| 17 | 大審判官·奧古斯丁 | 教會·審判庭首腦 | 異端追緝總源、後期宿敵 | 綱(A.10) |
| 18 | 行動頭目「火鉗」葛羅 | 燼火 | 激進派執行者、聖髑突襲燼火側 | 綱(A.10) |
| 19 | 持燈長老·盧瑟恩 | 啟明會核心 | 伊利安上線、更高層接點 | 綱(A.10) |
| 20 | 求是院司業·柯蘭 | 求是院·燭塔城 | 歐德蘭政敵、保守派 | 綱(A.10) |
| 21 | 矮人族長「鐵鬚」杜林 | 霜垠矮人氏族 | 矮人招募地把關人、機械嚮導 | 綱(A.10) |
| 22 | 精靈領之主·賽蘭薇兒 | 翠淵精靈領 | 精靈招募地接點、眠龕守護者 | 綱(A.10) |
| 23 | 盜遺者頭目「鹹手」摩根 | 盜遺者·碎島海 | 遺物走私灰市來源 | 綱(A.10) |
| 24 | 商盟代表「金算盤」哈丹 | 商人同盟 | 只問利的跨陸中間人 | 綱(A.10) |
| 25 | 怪部族首領「織議者」奎斯 | 覺醒怪部族·碎島海 | 會議事的政治行動者、血親伏筆 | 綱(A.10) |

> 深寫優先序（待登場時補 A.8／A.9）：**瑞德蒙（第二章）＞ 杜林·賽蘭薇兒（Phase 1 漫遊收同伴）＞ 葛羅·盧瑟恩·賽蘭薇兒（Phase 2 聖髑突襲）＞ 奧古斯丁（後期宿敵）**。
...
> 對接 bible §10（鐵則：**只暗示、不明說**）、H.1（汙染伏筆）、H.2（殘響載體）。下表給四階段的**口吻錨**與**示範台詞**（暫擬可改），讓未來寫殘響/對白有一致調性。**通則**：她記憶錯亂、自己也拼不全真相，所以**愛打啞謎、第二人稱、片段化**；越靠近真相越清晰，唯有終章斬鏈那一刻才完全清醒。
...
| **中期·實體化（汙染未露）** | 能正常對話，但**總把話頭引向母星**、靠近泰拉之物異常亢奮（H.1 伏筆）——*玩家該在這種反常裡比隊伍更早起疑*。 | 「往上走。答案在那顆亮著的星上，一直都是。」<br>「我們快到家了。你不覺得……心跳得很快嗎？」 |
| **終章·斬鏈（奪回自己）** | 唯一完全清醒的一刻：第一人稱、不再打啞謎，認清自己被利用、主動關上內線（§H.4／bible §10.6）。 | 「我聽見它在我腦子裡，從醒來那天就在。……現在，讓我替你們關上這扇門。」 |

> **鐵則重申**：終章泰拉之前**只給上述前三階段的伏筆、不點破**，好讓她一路被信任、把眾人領到泰拉；第四階段口吻只在斬鏈當下解鎖。
...
flowchart TD
    ...
    FORK -->|投反抗| T2["聖城 半揭"]
    T2 --> T3["終章泰拉 全揭"]
    T3 --> T4["領航者 獻祭斬鏈<br/>＝關閉內線·掩護撤離"]
    T4 --> ENDT(["結局：流浪方舟<br/>末日卻解放（真結局）"])
    T3 -. 沒搶到關鍵／沒及時逃 .-> ENDF(["結局：覆滅（fail）"])
    FORK -->|助帝國| E2["平叛（剿燼火·啟明會·清洗離心）"]
    E2 --> E3["永封／斬斷領航者<br/>＝關閉內線·AI 重新失明"]
    E3 --> E4["晉身帝心"]
    E4 --> ENDC(["結局：牢籠長存<br/>安穩卻沉淪"])
```

> ★ **內線可斷模型的鏡像**：真相線的「獻祭斬鏈」與帝國線的「永封領航者」＝**同一機制兩面**（都是關閉 AI 唯一內線、令其重新失明），相反目的——**她為逃離而自獻、你為牢籠而永封**。
