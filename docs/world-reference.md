...
- **末世狂信分支：淨焰派（Ordo Purgatorius，煉淨聖團）〔暫名〕**〔bible §7.2〕：天燈將熄催生的**末世淨化狂信派**，啟明會的鏡像（求真 vs 迎末世）。
  - **教義**：天燈將熄＝神的末日大審判已至；以火淨化不潔、只讓純淨者在永夜前歸返皓月；**不求修好聖光**（復電＝抗神意），只求「配得上末日」。
  - **會幹的事**：①**淨化火刑**——公開焚燒瘟病者、畸形者（變樣血親）、靈能異常者、罪人異端，柴堆包裝成「餵回聖光／送他們先歸皓月」，越燒越密；②**末世佈道**裹挾饑民流民、隨天燈將熄壯成群眾狂潮；③**硬核小分支「永封使徒」**——把「別喚醒沉睡的機器」推到極致，聖物絕不可染指，反對尋回、想搶先毀掉／永藏聖物，**玩家開盒（B2）後成最狂熱的獵手**（「你喚醒了禁物、必須死、它必須重封」）。
  - **主線作用**：**幕二最強的王道道德灰區**（你是帝國的人，上頭要你約束、還是默許／利用這群狂信？護無辜還是保秩序？＝§9.1 幕二「末日教派」的具體臉）；幕四～五轉為開盒後的並行追兵（永封使徒）。
  - **領袖〔暫名〕**：**「舉火者·塞維林」（Severin the Fire-Bearer）**——非高階教士，而是天燈將熄中崛起的**末世先知型群眾領袖**（低階教士／苦修者出身），眼神灼亮、聲音蠱惑；正統教廷既想借他安撫恐慌、又壓不住。硬核「永封使徒」另可設一個脫韁前審判官為頭。
  - **關係**（暫以 prose 記、不擴 A.7 矩陣）：正統教廷 **▽**（同奉皓月、路線之爭：淨化 vs 秩序復電）｜大審判官奧古斯丁想收編控制卻壓不住｜啟明會 **⊗**（求真 vs 迎末世的鏡像死敵）｜燼火 **✕**（反抗軍恨其屠民）｜帝國 **△～▽**（想用它安撫恐慌、又怕它燒到稅基與秩序）｜變樣血親／怪部族＝獵殺對象（不知那是血親）。
  - **三重反諷（只給玩家）**：獻祭想重燃的聖光是機器、歸返的皓月是故鄉墳／餓神墓、真能重燃聖光的是領航者的死——血祭＝真獻祭的醜陋戲仿。

### A.3 啟明會／守燈人（Lampadarii）

- **接頭人**：〔持燈者·伊利安（Elian）〕——一名被褫奪聖職、暗中私研「遺物」的前教士，**懷疑「皓月之神」是假神**。史詩長弧接回日常的關鍵接點：**當初點撥燼火去奪聖髑（＝背景竊案，bible §2）**；玩家開盒叛逃後現身，領玩家走向真相與逃亡（重罪異端）。各懷鬼胎的灰色盟友，非全然可信。
...
> A.7.2／A.7.5 是「邊陲日常（前期）」的快照；下列**載重關係**會隨**五幕**里程碑位移。格式：起點 →〔轉折＠幕〕→ 終點。（下表殘留的 @N 為舊六章編號、僅表先後，一律以五幕為準：@1≈幕一、@2–4≈幕二～四、@5≈幕五。）

| 關係對 | 起點 | 轉折（章） | 終點 | 驅動 |
|---|---|---|---|---|
| 玩家隊伍 × 教會 | ✕ | 玩家開盒喚醒＋叛逃＠幕四（重罪異端） | **⊗**（攻聖城＠幕五 決裂） | 通緝升級、正面對決 |
| 玩家隊伍 × 攝政 | ✕（帝國追緝） | 利益交集＠5（玩家削教會＝攝政所欲） | **△→○ 可策反** | 攝政欲削神權的裂縫 |
| 啟明會 × 燼火 | △（各取所需） | 共抗清洗＠3–4 | **◎ 合流**＠5+ | 共破禁忌、推翻秩序 |
| 玩家隊伍 × 領航者 | ◎ 信任＠幕四開盒喚醒（B2） | 她隱瞞的伏筆累積、玩家隱約感到＠幕五 | **終章坦白→點火獻祭** | 戲劇性反諷、終章引爆 |
...
| 玩家隊伍 × 哈洛（離心領主） | △／○＠幕一（在地委託） | （B2 叛逃後）共抗審判清洗＠幕五 | **◎ 盟友／真相線暗中保護傘**（帝國線則✕清洗） | 叛逃後才結盟 |
...
- **對玩家功能**：幕一反派近景／壓力源。過境橡境搜異端，與務實的哈洛、地下的多恩形成三方張力（A.7.5：✕ 哈洛＝**幕一張力核心**、表面接待暗裡阻撓的貓鼠對峙）；玩家若顯露用遺物或庇護異端，他記下你。**玩家 B2 開盒叛逃後**，教會招安（悔罪贖罪、平步青雲）可由他來招手（帝國線／招安試探）。
- **口吻**：禮貌、輕聲、滴水不漏的威脅。「我不是來找麻煩的，鎮民。我只是來確認——這座鎮子，還乾淨。你會幫我確認的，對嗎？」
- **跨章弧線**：幕一過境施壓 → 前中期復現的獵手 → **玩家開盒叛逃後**遞「倒戈贖罪、平步青雲」（教會招安）→ 帝國線可成玩家上司／真相線是攻聖城前的一道關卡。
...
- **跨章弧線**：幕一在地委託／信任樞紐 → **玩家開盒叛逃後（B2）** 共抗審判清洗成 **◎ 盟友**（A.7.6）／真相線暗中保護傘 → **帝國線被玩家清洗**（I.6：✕ 清洗）。
...
- **對玩家功能**：**前期＝單純在地鐵匠（燼火身分後撤、後揭）**；玩家 **B2 開盒叛逃後**才顯露反抗組織入口身分，引介進燼火、接觸上層燼火與啟明會。
- **口吻**：直、悶、話少但有重量；信任前先試探。「打把鋤頭，三個銅板。……至於你想打聽的『另一種活兒』，得先讓我看看你這雙手——乾不乾淨。」
- **跨章弧線**：幕一在地鐵匠（中性）→ 玩家 B2 叛逃後顯露燼火身分、接上層燼火與伊利安 → 真相線並肩／帝國線被獵殺（I.6：⊗）。
...
- **祕密／與真相連結**：他**已摸到真相邊緣**（遺跡＝飛船、神話有假）；○ 瑟雷恩（隱修會「聖髑非聖」古祕＝真相線索）、○ 求是院、○ 燼火（A.7.5），被聖座克萊門斯／卡西安 ⊗ 死敵獵殺。**當初正是他點撥燼火去奪那件『神祕武器』（＝背景竊案，bible §2）**；玩家 **B2 開盒喚醒領航者後**，他確認真相、成為真相導師（H.3／I.2）。
- **對玩家功能**：**玩家開盒叛逃後**的真相導師／任務鏈樞紐；可信但動機自利，玩家需自判幾分真假。拼出竊案去向、通往真相線的引路者。
- **口吻**：審慎、引而不發、愛用反問。「你看過那些『神蹟之物』流血嗎？……不，它們不流血。它們**運轉**。一個會運轉的神，孩子，那還是神嗎？」
- **跨章弧線**：（幕前）點撥燼火奪聖髑＝背景竊案 → 玩家 B2 開盒喚醒領航者後現身、攤開真相 → 真相線並肩／帝國線被清洗。
...
> **觸發 → 反應**：①玩家用遺物／庇護異端被察覺→不當場發作，先記錄、佈線、等你牽出更大的網。②哈洛暗中阻撓→表面客氣、暗中向上呈報施壓。③玩家開盒喚醒／叛逃（重罪醜聞）→死命追緝、升級為主要獵手。④玩家露出可招安跡象→遞「悔罪贖罪、平步青雲」橄欖枝（帝國線教會招安）。
...
> **觸發 → 反應**：①審判官過境→殷勤接待＋暗中通風報信給多恩＋拖延配合。②玩家解決在地危機→逐步加碼信任（真正引介燼火留到玩家 B2 叛逃後）。③帝國加稅／清洗逼太緊→暗中倒向燼火更深（玩家叛逃後共抗清洗成 ◎ 盟友）。④玩家連累橡境／暴露他通敵→翻臉切割保命。
...
> **觸發 → 反應**：①玩家開盒叛逃、把聖髑揭成機器（教會最想埋的醜聞）→嗅到籌碼、主動遞交易（庇護換辦事、幫他剪神權；B2 叛逃後的攝政借刀岔誘，I.2）。②玩家替他削了教會→給更多權與庇護、但同時防著你。③玩家失去利用價值或倒向反抗→棄子、甚至反手獻給審判庭。④皇帝想收權→暗中架空、必要時逼宮。
...
> **觸發 → 反應**：①帝國高壓清洗→轉入更深地下、以殉難者神話再動員。②玩家證明可靠→納入網絡、賦予更重任務。③啟明會帶來真相（玩家叛逃後）→合流，從反暴政升級為「破禁忌、發動方舟逃離」同盟。④玩家倒向帝國→成為被獵殺的前盟友（帝國線 ⊗）。
...
> **觸發 → 反應**：①帝國暴行→主張立即報復性打擊（可能連坐無辜）。②餘燼要持重→不滿、可能擅自行動。③（開場前）奪聖髑的背景竊案→他是「欲毀之」那一手的執行者（bible §2／I.1），衝在最前。④玩家手軟／顧慮無辜→嫌你婆媽。
...
> **立場**：帝國伐木傳教＝✕侵入者（蠶食翠淵）｜人類＝若即若離的悲憫｜啟明會／燼火（當年來奪聖髑的背景竊案）＝闖過她這關的人｜玩家（尤其精靈隊員）＝有限的接納｜眠龕「聖髑」＝或有模糊感應卻宿命旁觀（如今已被劫空）。
> **決策風格**：緩、不強加、以宿命態度旁觀；給線索而非答案；守護但不阻擋註定之事。
> **觸發 → 反應**：①帝國前哨進逼翠淵→精靈自衛、與玩家／燼火可結盟。②（幕前）燼火來奪聖髑→她是守關者：測試來者，或宿命地「終究沒攔住」（讓竊案得手，bible §2）；如今守著被劫空的眠龕、可給玩家追查去向的線索。③玩家是精靈／有誠意→開放招募與線索。④問起眠龕真相→只說當下聽不懂、事後才懂的話。
...
> **觸發 → 反應**：①玩家以平等姿態談判→以理性回應、可達協議（幕二 碎島海談判）。②人類以「剿滅異端」相待→自衛、聯合其他邊緣勢力。③涉及部族存續→交付共議、非個人拍板。④玩家展現「視怪為人」→難得的善意回應（血親伏筆）。
...
#### 新增·帝國親王派與離心領主
- **霜冠公·柯爾溫**（Corwin）｜帝國親王派·霜垠（B.2）：靠礦業特許堅定附庸的雪原親王，向帝國納貢、對礦工催苛役。幕二 霜垠「礦難／遺跡機械」事件的權力背景；堅定守禁忌，與自治的矮人氏族＝張力來源。
- **綠洲總督·塞拉斯**（Selas）｜帝國親王派·赤沙（B.2）：以納貢換半自治的綠洲城邦冊封總督，城府深、左右逢源。幕二 赤沙「綠洲水權」與學院鬥爭的政治莊家；務實，可撬但不易。
...
#### 新增·反抗與啟明會
- **燼火行動頭目·「火鉗」葛羅**（Grol）｜反抗組織燼火：餘燼這個神秘象徵之下、實際指揮破壞與突襲的激進派頭目。與餘燼的「象徵／務實」分工＝燼火內部「激進 vs 持重」張力；（開場前）奪聖髑背景竊案的燼火側執行者（「欲毀之」那一手，bible §2／I.1）。
- **持燈長老·盧瑟恩**（Lucern）｜啟明會核心：伊利安的上線、守燈人裡更老更謹慎的核心，掌著啟明會對真相的拼圖全貌。中後期玩家深入真相線的更高層接點；比伊利安更惜身、更懂取捨。

#### 新增·學派
- **求是院司業·柯蘭**（Kolan）｜求是院·燭塔城（B.2）：歐德蘭在燭塔城的學術政敵——保守派，主張靈能求知要對教會妥協、別踩禁忌。幕二 赤沙「學院鬥爭」的對手面；歐德蘭 vs 柯蘭＝求是院內部「冒進 vs 保守」之爭。

#### 新增·可玩種族故鄉領袖
- **矮人族長·「鐵鬚」杜林**（Durin）｜霜垠矮人氏族（D）：自治於礦山的矮人氏族長，善與遺跡機械打交道卻不知那是禁忌科技。**矮人開放招募地的把關人／嚮導**；深層機器密窖的天然帶路人，是「遺跡＝機器」揭密的關鍵在地視角。
- **精靈領之主·賽蘭薇兒**（Celandwe）｜翠淵精靈領（D）：長壽、靈能敏銳、與人類若即若離的精靈領袖。**精靈開放招募地的接點**；翠淵眠龕（領航者聖髑聖龕／至聖搖籃，H.3／I.1）所在地的守護者——（幕前）燼火奪聖髑的背景竊案必須過她這一關；如今守著被劫空的眠龕。
...
- **覺醒怪部族首領·「織議者」奎斯**（Quss）｜覺醒智能怪部族·碎島海（A.7.1 #13）：據島自治、會組織會談判的覺醒智能怪部族首領。幕二 碎島海「怪部族談判」的對象；**「怪＝會議事的政治行動者」**的具體化，是日後「怪＝變樣血親」覺醒的伏筆人物。
...
| 18 | 行動頭目「火鉗」葛羅 | 燼火 | 激進派執行者、背景竊案燼火側 | 模·綱 |
...
> 深寫優先序（決策模型 A.9.13–24 已補；下列為待登場時補 A.8 細節檔）：**瑞德蒙（幕二樞紐）＞ 杜林·賽蘭薇兒（幕二漫遊收同伴）＞ 葛羅·盧瑟恩（背景竊案／叛逃後反抗線）＞ 奧古斯丁（後期宿敵）**。
...
#### 反抗與啟明會
- **行動頭目「火鉗」葛羅**　**個性基調**：燒得太旺的火——恨意純粹、手段激進，常與「持重」的餘燼路線相左。**核心特質**：火爆激進｜行動至上（先砸了再說）｜對暴政切齒｜不耐煩政治算計。**口吻**：粗直、衝、帶火氣，講「砸爛它」多過講「怎麼砸」。**契合**：鐵砧鐵鉗出身的打擊手，信「不破不立」；（開場前）奪聖髑背景竊案「欲毀之」那一手正合脾性，也埋下「激進傷及無辜」的代價伏筆。
...
- **精靈領之主·賽蘭薇兒**　**個性基調**：疏離而古老的守林者——活得太久，對人類的急切只剩淡淡的悲憫。**核心特質**：疏離高潔｜長壽帶來的耐性與宿命感｜靈能敏銳近乎預感｜守護的責任（眠龕）。**口吻**：緩、詩意、隔著距離，常說玩家當下聽不懂、事後才懂的話。**契合**：千年精靈領的領袖，與人類若即若離；身為眠龕守護者，她對「聖髑非聖」或早有模糊感應卻宿命旁觀——（幕前）燼火奪聖髑的竊案要過她這關；如今守著被劫空的眠龕。
...
- **赤沙（沙漠）**：綠洲城邦以納貢換半自治。**靈能學院城燭塔城**坐落荒漠（知識藏於不毛的反諷），**求是院**大本營——自由求知、最易擦邊禁忌、意外踩進真相；盜遺者行會私掘沙下遺跡。**幕二·學院鬥爭**舞台。
- **翠淵（森林）**：巨木雨林、靈氣濃郁、帝國最難伸手之地。**精靈領**自成一格——長壽、靈能敏銳、與人類若即若離，**可玩同伴精靈的故鄉**；靜默隱修會的霧林隱院藏「聖髑非聖」的古老碎片。埋藏方舟**眠龕**（領航者聖髑聖龕／她的至聖搖籃）深藏其中——**近期竊案的發生地：聖髑已被燼火自此奪走、如今是被劫空的犯罪現場**（賽蘭薇兒守著空龕、可給玩家線索；喚醒改由玩家在幕四於失落聖物的 lost hold 開盒觸發，見 §I）。帝國的伐木傳教前哨正步步進逼。
- **帝心（核心）**：帝國—教會權力中樞，文明化腹地。**皓月聖城＝這艘方舟（創世號）的指揮中樞**坐落於此。核心地帶非附即敵，中立幾無，最深的反抗（燼火總部）只能隱於帝都地下。**真相線·攻入聖城中樞、半揭當面浮現**。
- **碎島海（群島）**：鞭長莫及的海疆，走私與私掠的灰色海域。沉沒方舟殘骸遍佈（**沉艙**＝有運作中機器的深層船艙，幕二**「這是機器、不是墓」**首悟可掛此）；商人同盟與盜遺者母港在此，甚至有**覺醒智能怪部族**據島自治、成為談判桌上的勢力。
...
> 真相揭密拆成玩家一塊塊拼出的順序，對應**五幕王道收束**（幕一～二王道漫遊 → 幕四開盒喚醒 → 幕五真相線）的關鍵地城。前三塊在**幕一～二零星浮現**（玩家多以帝國視角誤讀、說不上來哪裡不對）、後三塊隨**開盒叛逃與真相線**推進。真相是掙來的：越往中心越驚悚。（本檔散見的「第N章／ch.N」是舊六章編號，僅表大致先後，一律以五幕與 bible §9.1 為準。）

| 階段 | 關鍵地城〔暫名〕 | 玩家在此拼出的一塊 |
|---|---|---|
| 幕一·起點（橡境） | 西南野**淺層船艙殘骸** ／ **晦礦**邊緣 | 「遺跡邊緣的怪物異常」「這石頭不像石頭」——純伏筆，說不上來哪裡不對；領航者第一道殘響 |
| 幕二·跨海（碎島海） | **沉艙**（the Sunken Hold）：有**運作中的機器** | 首次「**這是機器、不是墓**」；撿到「不是魔法」的遺物（科技）；驚覺部分怪物像人 |
| 幕二·沙漠（赤沙） | 燭塔城周邊遺跡／**真實歷史殘檔**所在 | 「裂縫」鐵證：遺跡＝飛船、怪物＝血親、神話有假；尋回一段真實歷史殘檔 |
| 喚醒（幕四·失落聖物 lost hold） | **失落聖物的 lost hold**（＝孤兒地城 `level01` 重定位）＝竊案後聖髑輾轉流落之地；眠龕已被劫空（幕二調查點） | **玩家開盒喚醒**領航者實體化（＝那具核心離座、世界失穩加劇）、揭更多真相，確認泰拉那東西**殺不死**——絕望初現；她全程誠實，只是連她也以為餓神早死 |
...
> **孤兒地城 `level01`**：重定位為**幕三·失落聖物所在的 lost hold**（竊案後聖髑輾轉流落之地／機器密窖），須符合「離起點遠、後期才深入」原則，**不要緊貼橡鎮接上**。
...
- **泰拉非取不可之物＝失落的科技（不是第二顆核心）**：飛出星系需要的最後那塊工程，當年來不及帶、留在了冰封的泰拉。**它＝「如何在沒有她的情況下、把核心當純能源駕馭」**——平時只有她這活體看守鎮得住那口星火（**這艘船擱淺 4 萬年、當年逃亡跳來不及完成、那趟星際跳躍始終未竟，她供的只是維生涓流、不是推進**）；**她能永遠關著這顆星，卻只能在一次全功率全放中釋放它來推船跳離——那一次全放把「她」耗盡（星火本體並未耗盡、留存後靠這份科技續航）**。她一旦在點火中燒盡，往後的流浪航程就得靠這份科技運轉核心。**你去取的，正是失去她之後活下去的辦法。**
...
### H.3 「聖遺物」所在的遺跡（開盒喚醒之地）

- 那件「**聖遺物·聖露希亞**」＝領航者休眠的仿生軀體，也就是**供養全世界的那具命脈核心**，原囚於埋藏方舟深處的**眠龕（Reliquary of Slumber）＝她的至聖搖籃**。**沒有人知道全世界的命脈就是她**（世人膜拜的是天上的皓月）。**近期竊案把她從眠龕奪走、失落在外**（bible §2）——眠龕如今是**被劫空的犯罪現場／幕二調查點**，聖髑輾轉流落到失落聖物的 **lost hold**。
- **喚醒＝玩家開盒**：帝國依「持光聖女預言」發動尋回、由**主教召喚**派玩家取回聖髑；真正的喚醒在**幕四玩家於 lost hold 親手開盒（好奇僭越）**觸發——封印一破她即甦醒。若玩家選 B2 不帶回、由她引路，此刻同時是**救出＋解封＋取得同伴**三合一；**喚醒＝命脈離座、世界失穩加劇**。
- **聖髑反諷**：當年噤聲她、如今為救世界急著尋回她的同一個宗教，其實是要把她**重新封回搖籃當電池**（帝國線牢籠）；救主被當「要修好的聖光」尋回，沒人知道她是活的命脈。
- **線索鋪陳**：靜默隱修會（瑟雷恩）可能握有「聖遺物非聖、實為沉睡之物」的古老碎片；賽蘭薇兒守著被劫空的眠龕——都是通往 lost hold、拼出竊案去向的暗線。

### H.4 收法：點火獻祭（已定，bible §10.6）

- 終章傾巢總攻之下，**點燃核心、發動方舟跳出星系**——這一點火，就是把她的人型與意識當成跳躍的燃料燒盡（Melina 式獻祭）。**燒的是「她」＝那個能把整顆星即時全放一次的調節心智，不是星火本體；她能永遠關著一顆星（涓流維生、船擱淺 4 萬年、那趟星際跳躍始終未竟），卻只能釋放它一次——那一次全放把她耗盡，星火留存後靠泰拉科技續養流浪方舟（bible §10.4）。**
...
> 對接 bible §9.1（五幕）、§9.2。**設計（已定）**：機制＝**幕四「要不要打開那口封印聖遺物」的開盒抉擇**（前期純王道、反抗線抉擇後才展開）；帝國結局＝**「牢籠長存」**（含 B1「知情的牢籠」變體）；真相線內容量＝**完整戰役**。**自洽根（價值抉擇模型）**：核心能量無盡、**留下不會死**（把核心放回搖籃當全船的電源就能永續苟活）；故分支不是保命 vs 送死，而是**求真招險換自由（真相線）vs 埋真苟活保安穩（帝國線）**。

### I.0 全景流程圖

```mermaid
flowchart TD
    A1["幕一～二 王道漫遊（前中期·大幅）<br/>邊陲在地英雄→帝國體制內晉升<br/>清剿『盜聖光異端』燼火·平天燈將熄暴動·追查失落聖物<br/>領航者殘響暗線；反抗線尚未展開"]
    A3["幕三 主教召喚·隱藏任務<br/>秘密尋回失落的持光聖女聖髑<br/>抵達失落聖物的 lost hold"]
    BOX{"幕四 那個盒子<br/>要不要打開封印聖髑？"}
    A1 --> A3 --> BOX
    BOX -->|A 不打開·直接帶回| E1["送回搖籃→天燈復明·世界恢復正常"]
    BOX -->|B 打開＝喚醒| OPEN["她甦醒·人型·記憶錯亂但誠實<br/>＝核心離座·世界失穩加劇·真相開始"]
    OPEN -->|B1 明知是活人·仍帶回| E1
    OPEN -->|B2 不帶回·由她引路| R1["反抗線：一叛成通緝<br/>領航者翻轉認知·天然盟友＝當初的『盜賊』（燼火/啟明會）"]
    E1 --> E2["帝國線平叛（剿燼火·啟明會·清洗離心）→晉身帝心"]
    E2 --> ENDC(["結局：牢籠長存<br/>A＝不知情／B1＝知情的牢籠<br/>安穩卻沉淪"])
    R1 --> T2["聖城 半揭"]
    T2 --> T3["終章泰拉 全揭"]
    T3 --> T4["領航者 點火獻祭<br/>＝燒盡自己·發動方舟跳離"]
    T4 --> ENDT(["結局：流浪方舟<br/>末日卻解放（真結局）"])
    T3 -. 沒搶到科技／沒及時逃 .-> ENDF(["結局：覆滅／放虎歸山（fail）"])
    T4 -. 額外掙得·稀有 .-> ENDG(["金結局：解放領航者<br/>連她都救回來"])
```

> ★ **兩線的鏡像**：真相線**點火獻祭**（燒盡她、發動方舟逃離）與帝國線**把核心放回搖籃**（讓她繼續供養全世界、餓神繼續沉睡）＝對同一件事的相反選擇——**燒掉她換自由 vs 留著她換安穩**。**B1「明知她是活人仍把她留著」＝知情的牢籠，是這面鏡子最利的一刀。**

### I.1 喚醒＝玩家開盒僭越（自洽）

- **背景竊案（開場前）**：當年**燼火**（受**啟明會**點撥、以為是武器／權力來源）突襲翠淵眠龕、**奪走封印聖髑**，卻在混亂中失落（bible §2）——這一手「欲毀之」下放為**開場前的背景事件**，不再是玩家親歷的中期突襲。教會與反抗軍如今都沒有她。
- **帝國要的是「尋回並重新安座」**：教會依「持光聖女預言」發動尋回、要把她**送回搖籃當電池**（＝帝國線牢籠）；帝國永遠只封埋、絕不喚醒——這仍天生把兩線分乾淨。
- **真正的喚醒＝玩家開盒**：中期**主教召喚**派玩家（帝國的人）去取回聖髑；玩家在幕四於失落聖物的 lost hold **親手打開那口封印聖龕（好奇僭越）**，封印一破她即甦醒。**是玩家的好奇、不是效忠宣誓，觸發了喚醒**；喚醒＝那具核心離座、世界開始失穩（且沒人知道那頭餓神只是裝死）。此時 party 仍是帝國的人、尚未選邊——選邊在**開盒之後**（§I.2）。

### I.2 開盒之後：反抗線串接（B2）

> 目標：**幕四開盒＋B2 不帶回**之後，玩家由帝國的人一步步被真相推成反抗者——反抗線在此才展開（呼應 bible §0「抉擇後才展開反抗線」）。框架＝**真相讓你無從選邊**，不是「兩邊都玩過再選」。

**四步串接：**

1. **一叛成通緝**：你沒帶她回去（或被發現打開／帶走她），瞬間成帝國頭號要犯——「**偷走了能救世界的聖光**」。**百姓恨你**（他們以為你扣住救贖，而天燈仍在熄）＝殘酷反諷＋巨大壓力。
2. **領航者翻轉認知**：她誠實但打啞謎（記憶錯亂）地逐步揭示——帝國要的「救贖」＝把她**永遠封回搖籃當電池、保一座無知牢籠**；真相在外（遺跡＝飛船、皓月＝故鄉墳、怪＝血親）；真有活路（回泰拉、逃離死星系）。她誠實藏著的獻祭代價（點火燒盡自己）**暫不說**（H.1 鐵則：終章點火前只給伏筆、不點破）。
3. **天然盟友＝當初的「盜賊」**：你回不了頭，唯一會接納你的，正是帝國口中的異端罪犯——**燼火與啟明會，也就是當初闖眠龕偷走她的人**。串接的漂亮處：反抗軍不是天上掉下來的盟友，而是「**早就看穿帝國祕密、試圖奪取／揭露、被打成恐怖分子**」的人。你打開盒子、知道真相後，才懂他們當初為何那麼做——多恩（燼火）、伊利安（啟明會）在此**重新定義為並肩者**（A.8）。
4. **王道全被重新定義**：你前中期剿的「叛軍」、掙的帝國信任，回頭看全是在維護牢籠。反抗線＝**護送領航者、與燼火／啟明會合流、拼出全部真相**（聖城半揭 → 泰拉全揭，§E）、走向逃離。**你走上反抗之路不是被早早招募，而是真相讓你無從選邊。**

> **接 §I.3**：反抗線＝真相線，聖城半揭 → 泰拉全揭 → 點火獻祭。
> **（可選）攝政借刀的餘溫**：叛逃後，攝政瑪克森提烏斯仍可能遞來「回頭擁抱權力」的世俗誘惑（削教會、給庇護）——一次「你其實還能回帝國線」的岔誘，但倒向他＝撐起暴政的世俗半邊（A.9.6）。非主線。

### I.3 真相線（反抗）＝真結局

接 §9.1 幕五（**B2 開盒＋不帶回**）：聖城**半揭** → 終章泰拉**全揭**。終章由她**點火獻祭**（燒盡自己、發動這艘方舟的引擎）掩護眾人跳離；方舟駛離死星系。**末日卻解放。**

### I.4 帝國線（壓迫秩序）＝牢籠長存（完整平行戰役）

**由 A（不打開帶回·不知情）或 B1（打開·明知·仍帶回·知情）進入。** 送回聖物後**天燈復明、世界恢復正常**，你成了「尋回持光聖女、拯救世界的英雄」——凱旋、受封。之後是與真相線**鏡像對照**的中後期戰役：

| 章 | 帝國線 | 與真相線的鏡像 |
|---|---|---|
| **天燈復明·凱旋** | 送回聖物→聖光重穩、饑荒止、異變逆轉；你是「尋回持光聖女」的救世英雄，凱旋受封 | 真相線帶核心去泰拉點火，帝國線把核心送回搖籃「修好天燈」 |
| **平叛** | 受審判庭／帝國重用，掃蕩燼火網絡、追剿啟明會、清洗離心領主 | 真相線結交盟友，帝國線在此**獵殺**他們 |
| **把核心送回搖籃** | 把聖髑（＝那具核心）**送回搖籃、繼續供養全世界**，封鎖真相、永埋醜聞——**A＝她始終封印未醒（你不知她是活人）；B1＝你已開盒、明知她是活人仍送她回去長眠** | 鏡像真相線終章的**點火獻祭**：相反選擇——她為逃離燒盡自己、你為牢籠把她留著 |
| **晉身** | 平步青雲、受封進帝心、成為秩序支柱（新晉審判長／皓月之子近臣）；或瞥見「至聖本體」異常，被教義說服、選擇不深究 | 真相線攻入聖城揭穿，帝國線**走進聖城卻甘心不問** |
| **牢籠長存** | 核心繼續供電、餓神繼續沉睡、世界永續苟活——暴政與謊言永埋 | — |

> **平叛玩法**：危機解除後帝國清算——逐細胞獵殺燼火、肅清啟明會、整肅／清洗庇護反抗的離心領主（哈洛／瑞德蒙）。每役抬升聲望＝一串「拔據點·獵首領」任務，終至新晉審判長／皓月之子近臣（I.6）。
>
> **「假」的那一刀（只給玩家、不給角色）**：聖物重新封存、無人再問；走樣神話更硬化；天燈「修好」了，卻**偶爾又微微閃爍**（調節只是被打補丁、退化仍在——牢籠買的是時間不是未來）。可選演出 beat：加冕慶典萬眾歡呼你為救主，對玩家穿插真相一瞥（守燈人被拖走前低語一句／聖髑聖龕重新祝聖那一格看起來像棺材）。角色在笑，玩家發寒。
>
> **最後一刀（反諷）**：你頭頂膜拜的皓月，正是你們自己凍死的故鄉；你用一生維護的「安全」，就是一座永遠餓不死、也永遠活不起來的牢籠，而**你永遠不會知道**（B1＝你甚至已經知道、卻仍選了它）。**安穩卻沉淪。**

### I.5 結局總表

| 結局 | 路線 | 性質 | 一句話 |
|---|---|---|---|
| **流浪方舟**（真結局） | 真相線·B2 | 末日卻解放 | 毀掉舊世界、逃向新家；唯一的勝利是活著離開 |
| └ 變體：點火獻祭／領航者殘響 | 真相線·B2 | 苦／苦中帶甜 | 見 H.4、bible §10.6 |
| **金結局：解放領航者**（稀有勝利） | 真相線·B2 | 亮 | 靠泰拉失落科技的更完整版＋額外代價，把恆星能量抽進真正的反應爐——方舟照飛、**她重獲人身活下來**（要玩家多掙一大段才配得到；解鎖條件留待寫終章定，draft §C.1） |
| **覆滅**（fail，可選） | 真相線·B2 | 悲劇 | 沒搶到科技或沒及時逃，被傾巢的機器海吞沒 |
| └ 暗變體：放虎歸山／緩死漂流／永困鐵中 | 真相線·B2 | 更暗 | 放虎歸山＝造物主奪回核心徹底復活、掙脫死星系（你害了往後一切）；緩死漂流＝逃出卻殘破、在星海慢慢死；永困鐵中＝她燒不盡、意識永困機器裡醒著（draft §C.2） |
| **牢籠長存·A**（不知情） | 帝國線·A | 安穩卻沉淪 | 不打開直接帶回，維持牢籠而「贏」，真相永埋、你永遠不會知道 |
| **牢籠長存·B1**（知情的牢籠／共犯的安穩） | 帝國線·B1 | 更狠 | 打開、明知她是活人、聽了真相，仍把她送回去永遠當電池；她不怨、留一句誠實寬恕的話再度長眠 |
...
| 玩家 × 燼火／啟明會 | ✕（幕二即奉命清剿「盜聖光異端」）→ **⊗ 徹底獵殺** | 帝國線始終與他們為敵、危機後趕盡 |
| 玩家 × 離心領主（哈洛） | △／○（幕一在地委託）→ **✕ 清洗** | 倒向帝國、清算庇護反抗的離心領主 |
| 玩家 × 領航者 | **A＝始終未醒即封回／B1＝明知她是活人仍送回** → **送回搖籃、繼續供養全世界** | 埋掉真相、把她永遠留作電池 |
...
> 對接 bible §0／§2／§3、§E、§A。**設計原則（通用生成器）**：**這個世界最神聖或最恐懼的傳說，幾乎都是某個科幻事實的走樣記憶。** 民眾用奇幻語彙去解釋方舟／核心／泰拉／造物主留下的痕跡。這批同時是**氛圍**、**前中期把玩家一塊塊拉近真相的伏筆庫**、**任務鉤**。

| 走樣傳說（世人所信） | 隱藏真相（科幻事實） | 戲劇／任務用途 |
|---|---|---|
| **「天燈將熄＝末日凶兆」**：太陽閃爍、日照變短、外圈失溫＝「神在收回聖光，因我們有罪」。 | 核心（＝領航者）被奪離搖籃、供電**調節退化**（bible §10.1／§2 近期竊案）。 | **開場危機的神話臉**；任務鉤：末日教派、假先知、贖罪苦行、搶囤糧的邊城。 |
| **★「持光聖女的沉睡預言」**：教會密藏——「當天燈將熄，長眠的持光聖女將甦醒，指引子民」。 | **喚醒核心／領航者**的走樣預言。 | **★主線扳機**：教會據此讀天燈將熄、發動尋回聖物的行動（幕三主教召喚的宗教根據）。反諷＝預言說她醒來會拯救，她一醒世界反而更失穩，她真正的「拯救」是她的死。 |
...
| **「世界的邊緣」**：走到大地盡頭會撞上「神的牆」，越界者永不歸。 | 那是**方舟的船殼／艙壁**。 | 解釋「越外圈越荒涼詭異」＝越近失修船壁與鑄造機野化區；探邊任務。 |
| **（附）「鐵中的低語」**：靠近遺物聽見人聲＝瘋狂前兆／亡者呼喚。 | 沉睡核心的破碎殘響（見 §H.2）。 | 早期領航者殘響的在地包裝；恐怖氛圍＋伏筆（既有 `nav_echo_nest`）。 |

> **交叉引用**：與 §E（真相里程碑）、§A（教會·啟明會）、bible §4（怪物來歷）交叉使用。持光聖女預言＝ §I 開盒抉擇樹前置的宗教包裝：幕三教會派玩家尋回「持光聖女」，玩家在幕四決定要不要打開那口盒子。**末世狂信派「淨焰派」（§A.2）把「天燈將熄＝天罰」與「死者歸於皓月」兩條走樣神話推成末世血祭與淨化火刑——走樣神話武器化的最恐怖範例。**
...
| 孤兒地城 `level01` | E 節：重定位為幕三·失落聖物所在的 lost hold，放遠、後期 |
